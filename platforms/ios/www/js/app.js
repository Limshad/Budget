...
(function() {
    ...
    app.controller('ContactController', function($scope) {
	 ...
	 // Location Controller
    app.controller('LocationController', function($scope, $http, LocationData) {
        
        $scope.locations = [];
        
        $http({method: 'GET', url: LocationData.url}).
        success(function(data, status, headers, config) {
            $scope.locations = data.result;
            $scope.letterLimit = LocationData.letterLimit;
			$('.loading_up').fadeOut('slow');
        }).
        ...
        $scope.showDetail = function(index) {
        var selectedItem = $scope.locations[index];
        LocationData.selectedItem = selectedItem;
        $scope.ons.navigator.pushPage('locationView.html', selectedItem);
        }
        
        // getNews() function()
        $scope.getLocations = function() {
            // Filter News by $scope.search
            return $scope.locations.filter(function(item) {
